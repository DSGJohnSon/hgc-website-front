...
export default function TestimonyContent({
  ...
  return (
    <div className="flex flex-col items-center gap-10 py-16">
      ...
      <div className="relative px-8 min-h-50 md:min-h-45 flex items-center justify-center">
                ...
                className={cn(
                  ...
                  showName
                    ? cn(
                        ...
                        "before:absolute before:top-0.75 before:left-0.75 before:w-2 before:h-[calc(100%-6px)] before:bg-gray-950 before:z-[-1] before:transition-all before:duration-200",
                        "before:[clip-path:polygon(85%_0,100%_0,15%_50%,100%_100%,85%_100%,0%_50%)]",
                        "after:absolute after:top-0.75 after:right-0.75 after:w-2 after:h-[calc(100%-6px)] after:bg-gray-950 after:z-[-1] after:transition-all after:duration-200 after:rotate-180",
